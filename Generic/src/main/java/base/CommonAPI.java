...
public class CommonAPI {
    ...
    //Commons Email: send email if Test Fails
    @AfterMethod
...
//------- Below are methods by WebElement -------//
...
//------- Below are methods Window Size and Navigation -------//
...
//------- Below are methods for Handling Alert -------//
    public void okAlert(){
...
//------- Below are methods for iFrame Handle -------//
...
//------- Below is a method to get Links -------//
    public void getLinks(String locator){
        driver.findElement(By.linkText(locator)).findElement(By.tagName("a")).getText();
    }
//------- Below are methods for Capturing Screenshots -------//
...
//------- Below is a method for Handling New Tabs -------//
...
//------- Below is a method for Pop Up Window-------//
